...
import circleSVGDark from "../assets/Component-2-dark.png";
...
const EmiCalculator = ({ theme }) => {
    ...
    const arithmeticLightText = "text-gray-700";



    const containerClass = `flex flex-col gap-[30px]   md:mx-auto
    ${theme === 'light' ? arithmeticLightText : 'text-[#fff]'}`;
    ...
    return (
        <div className='flex flex-col justify-center items-center gap-[40px]  w-full md:w-[70%]'>
            <div>
                    ...
                    <div className='flex flex-col md:flex-row gap-[10px] md:gap-[20px] items-center'>
                        <div className='md:w-[25%] px-[10px]'>
                            <div className=" flex items-center justify-center  relative w-[160px] h-[160px] md:w-[200px] md:h-[200px] mx-auto mb-4">
                                {
                                    theme === "light" ? (<img src={circleSVGDark} alt="" />) : (<img src={circleSVG} alt="" />)
                                }
                        ...
                        <div className='flex flex-col gap-4 md:w-[75%] font-semibold'>
                            <div className={`grid  md:grid-cols-3 gap-[26px] md:px-[20px] max-md:pt-[10px] ${theme == "light" ? "border-gray-600" : ""} md:border-l-[1px] max-md:border-t-[1px] border-[white] border-opacity-10 `}>
